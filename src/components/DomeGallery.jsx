...
export default function DomeGallery({
  ...
  useEffect(() => {
    ...
    const step = () => {
      if (!draggingRef.current && !focusedElRef.current && !openingRef.current && !inertiaRAF.current) {
        rotationRef.current.y = wrapAngleSigned(rotationRef.current.y + autoSpinSpeed);
        applyTransform(rotationRef.current.x, rotationRef.current.y);
      }
  ...
  }, [enlargeTransitionMs, unlockScroll, onToggleFocus]);
  ...
  const openItemFromElement = useCallback(
    ...
    [enlargeTransitionMs, lockScroll, openedImageHeight, openedImageWidth, segments, unlockScroll, onToggleFocus]
  );
